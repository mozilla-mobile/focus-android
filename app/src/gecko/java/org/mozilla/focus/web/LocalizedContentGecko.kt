...
object LocalizedContentGecko {
    ...
    private fun loadAbout(geckoSession: GeckoSession, context: Context) {
        ...
        geckoSession.loadString(data, "text/html")
    }
    ...
    private fun loadRights(geckoSession: GeckoSession, context: Context) {
        ...
        val content2 = resources.getString(R.string.your_rights_content2, appName,
            mplUrl)
        ...
        val content4 = resources.getString(R.string.your_rights_content4, appName,
            licensesUrl)
        substitutionMap["%your-rights-content4%"] = content4

        val content5 = resources.getString(R.string.your_rights_content5, appName,
            gplUrl,
            trackingProtectionUrl)
        substitutionMap["%your-rights-content5%"] = content5

        putLayoutDirectionIntoMap(substitutionMap,
            context)
