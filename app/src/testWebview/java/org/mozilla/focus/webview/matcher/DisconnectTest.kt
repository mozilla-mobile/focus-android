...
class DisconnectTest {
    ...
    fun matches() {
        val matcher = UrlMatcher.loadMatcher(
            RuntimeEnvironment.application,
            R.raw.blocklist,
            intArrayOf(R.raw.google_mapping),
            R.raw.entitylist
        )
        // Enable everything
        ...
        prefs.edit()
            .putBoolean(
                RuntimeEnvironment.application.getString(R.string.pref_key_privacy_block_ads),
                true
            )
            .putBoolean(
                RuntimeEnvironment.application.getString(R.string.pref_key_privacy_block_analytics),
                true
            )
            .putBoolean(
                RuntimeEnvironment.application.getString(R.string.pref_key_privacy_block_other),
                true
            )
            .putBoolean(
                RuntimeEnvironment.application.getString(R.string.pref_key_privacy_block_social),
                true
            )
            .apply()
        ...
        assertTrue(
            matcher.matches(
                Uri.parse("http://admeld.com/foobar"),
        ...
        assertTrue(
            matcher.matches(
                Uri.parse("http://google-analytics.com/foobar"),
                Uri.parse("http://mozilla.org")
            )
        )
        assertFalse(
        ...
        assertTrue(
            matcher.matches(
                Uri.parse("http://plus.google.com/something"),
                Uri.parse("http://mozilla.org")
            )
        )
        assertFalse(
