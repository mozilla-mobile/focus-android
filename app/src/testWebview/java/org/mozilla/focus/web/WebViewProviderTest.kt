...
class WebViewProviderTest {
    ...
    fun testGetUABrowserString() {
        ...
        assertEquals(
            "AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 $focusToken Chrome/37.0.0.0 Mobile Safari/537.36",
        ...
        assertEquals(
            "ImaginaryKit/-10 (KHTML, like Gecko) Version/4.0 $focusToken Chrome/37.0.0.0 Mobile Safari/537.36",
        ...
        assertEquals(
            "AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Imaginary/37.0.0.0 Mobile Safari/537.36 $focusToken",
            WebViewProvider.INSTANCE.getUABrowserString(chromeless, focusToken)
        )
        // No AppleWebkit, no Chrome
        val chromelessImaginaryKit =
            "Mozilla/5.0 (Linux) ImaginaryKit/-10 (KHTML, like Gecko) Version/4.0 Imaginary/37.0.0.0 Mobile Safari/537.36"
        assertEquals(
            "ImaginaryKit/-10 (KHTML, like Gecko) Version/4.0 Imaginary/37.0.0.0 Mobile Safari/537.36 $focusToken",
